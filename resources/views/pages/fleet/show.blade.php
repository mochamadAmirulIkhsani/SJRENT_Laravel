            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="{{ $settings->getWhatsAppLink('Halo, saya tertarik untuk rental ' . $motorcycle->name . '. Apakah masih tersedia?') }}" 
                           target="_blank"
                           rel="noopener noreferrer"
                           class="block w-full text-center bg-green-500 hover:bg-green-600 text-white px-8 py-5 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        ...
                        <a href="{{ route('fleet.index') }}" 
                           class="block w-full text-center bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300">
                            Lihat Motor Lainnya
                        </a>
                    </div>
                </div>
